...
public interface IEmailService {
    ...
    /// <summary>
    /// Sends an email to a given email address, confirming the user has successfully registered for a time slot
    /// </summary>
    /// <param name="email"></param>
    /// <param name="batch"></param>
    void SendReservationConfirmationEmail(string email, Batch batch);
    ...
    /// <param name="email"></param>
    /// <param name="batch"></param>
    void SendReservationUpdateEmail(string email, Batch batch);
    ...
    /// <param name="email"></param>
    /// <param name="batch"></param>
    void SendReservationCancellationEmail(string email, Batch batch);
}